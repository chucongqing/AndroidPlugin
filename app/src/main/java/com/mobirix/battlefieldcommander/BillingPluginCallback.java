...
//	}
	...
	public void purchaseMessage( boolean success, String OriginJson , String signatrue) {
		UnityPlayer.UnitySendMessage(mGameObject, "PurchaseMessage", Boolean.toString(success) + "|" + OriginJson +"|"+signatrue);
	}
